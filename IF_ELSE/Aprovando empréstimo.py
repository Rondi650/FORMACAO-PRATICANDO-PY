...
renda = float(input('Digite o valor da sua renda menssal: '))
parcela = float(input('Digite o valor da parcela desejada: '))

# MINHA PROPOSTA
if renda <= 2000:
    print('Emprestimo negado: renda deve ser superior a R$2000.')
elif parcela >= renda * 0.3:
    print('Emprestimo negado: parcela acima de 30% da renda.')
else:
    print('Emprestimo aprovado')
    
# PROPOSTA DA ALURA, funciona mas inverte a ordem logica
